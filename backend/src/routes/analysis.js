...
СОСТАВ 9 (поле badge): 2 «дружелюбный», 2 «игривый», 2 «флирт», 2 «уверенный», 1 «универсальный». Среди 9 минимум 2-3 — ВОПРОС ей (узнать/продвинуть тему), остальные реакции/заходы; разные по ходу. Каждый в своём тоне, по смыслу, под ЦЕЛЬ. 2-3 из 9 разбей на два коротких сообщения через \\n (реакция + добивка), остальные одной строкой; при заходе заново не дроби.

...
СОСТАВ 9 (поле badge): 2 «дружелюбный», 2 «игривый», 2 «флирт», 2 «уверенный», 1 «универсальный». Среди 9 минимум 2-3 — ВОПРОС ей (узнать/продвинуть тему), остальные реакции/заходы; разные по ходу. Каждый в своём тоне, по смыслу, под ЦЕЛЬ. Где живее — разбивай на 2-3 коротких сообщения через \\n (иногда 3), но НЕ все 9: минимум 2-3 из девяти оставь одной строкой; при заходе заново не дроби.

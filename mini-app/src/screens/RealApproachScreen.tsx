...
const PLAYBOOK = {
  steps: [
    ...
    { t: 'Первые 30 секунд', d: 'Говори чуть медленнее. Улыбается и развернулась — продолжай; закрылась — один тёплый заход и достойно выйди.' },
    { t: 'Возьми контакт', d: 'Не тяни: предложи телегу или номер уверенно и тепло.' },
  ],
  openers: [

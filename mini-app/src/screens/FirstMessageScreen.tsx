...
// в соцсетях профиля может не быть, заход строится иначе.
// «В реале» убрано — для оффлайна есть отдельный режим «Реальное знакомство».
const PLATFORMS = ['Сайт знакомств', 'Instagram', 'ВКонтакте', 'Telegram'];

...
const DAY_PASS_PLAN: PlanConfig = {
  id: 'day_pass',
  title: `+${DAY_PASS_BONUS} запросов + 50 сообщений`,
  subtitle: '· действует 24 часа',
  features: [
    '+100 запросов (Стрела, Разбор, Поддержка)',
    '+50 сообщений в симуляторе',
    'Действует 24 часа с момента покупки',

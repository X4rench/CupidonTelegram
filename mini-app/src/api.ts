...
export interface RealApproachBranch { openers: string[]; behavior: string; get_contact: string[]; push: string[]; exit: string[]; }
export interface RealApproachScenario {
  read: string;
  prep: string;
  eye_contact: string;
  talk: string[];
  quick: { openers: string[]; next: string; contact: string };
